...
public class StepDefRegister extends Base {
	...
	public void initialise_the_browser() {
	...
	public void enter_valid_credentials() {
		...
		c.getfirstname().sendKeys("Kaparthini");
		c.getlastname().sendKeys("Reshmi");
		c.getemail().sendKeys("kaparthini123@gmail.com");
		c.gettelephone().sendKeys("12345678");
		c.getaddress1().sendKeys("12,LNP Street");
		c.getaddress2().sendKeys("palayamkottai");
		c.getcity().sendKeys("Tirunelveli");
		c.getpostCode().sendKeys("627001");
	...
	public void entering_text_in_the_telephonefield() {
		...
		r.getfirstname().sendKeys("reshmi");
		r.getlastname().sendKeys("kaparthini");
		r.getemail().sendKeys("kaparthini34@gmail.com");
	...
	@Given("Initialising browser and navigating to url")
	public void initialising_browser_and_navigating_to_url() {
	...
	@Given("Select Affiliate link in Footer section.")
	public void select_affiliate_link_in_footer_section() {
	...
	public void entering_text_in_the_telephone_field() {
		...
		r.getfirstname().sendKeys("reshmi");
		r.getlastname().sendKeys("kaparthini");
		r.getemail().sendKeys("reshmi456@gmail.com");
		r.gettelephone().sendKeys("abcdef");
		r.getaddress1().sendKeys("12, LNP Street");
		r.getaddress2().sendKeys("Palayamkottai");
		r.getcity().sendKeys("Tirunelveli");
	...
	@When("Enter email address \"kaparthini.resh@gmail.com\"")
	...
	@Given("Select Gift Certificates link in Footer section.")
	public void select_gift_certificates_link_in_footer_section() {
	...
	@Given("Select Contact Us link in Footer section.")
	public void select_contact_us_link_in_footer_section() {
